...
export default HtmlElementsPlugin = (locations) => {
    this.locations = locations
  }
  
  HtmlElementsPlugin.prototype.apply = (compiler)=> {
    var self = this;
   ...
   * @returns {string}
   */
  const createTag=(tagName, attrMap, publicPath) =>{
   ...
   * @returns {string}
   */
  const getHtmlElementString=(dataSource, publicPath)=> {
